  ...
  <body>
    <section class="sectionHero">
      <div class="container">
        <div class="sectionHero__content">
          ...
          <a href="#contact" class="sectionHero__button button"
    ...
    <section class="sectionBenefits">
      <div class="container">
        ...
        <a href="#contact" class="sectionBenefits__button button"
          >Converse com um especialista agora</a
        >
      </div>
    </section>
      ...
      <div class="container">
        <div class="sectionSolution__wrapper">
          <div class="sectionSolution__left">
            ...
            <a href="#contatct" class="sectionSolution__button button"
              >Encontre a solução para você</a
            >
          </div>
          ...
          <a href="#contatct" class="sectionSolution__button-mobile button"
            >Encontre a solução para você</a
          >
        </div>
      </div>
        ...
        <div class="sectionHistory__wrapper">
          ...
          <div class="sectionHistory__content">
            <div class="container">
              ...
              <a href="#contact" class="sectionHistory__button button"
                >Fale conosco para saber mais!</a
              >
            </div>
          </div>
        </div>
        ...
        <div class="sectionHistory__wrapper">
          ...
          <div class="sectionHistory__content">
            <div class="container">
              ...
              <a href="#contact" class="sectionHistory__button button"
                >Descubra nossa atuação global</a
              >
            </div>
          </div>
        </div>
    ...
    <footer class="footer">
      <div class="container">
        <div class="footer__content">
          <img src="./assets/images/icon_pag.png" alt="Logomarca ZZ2" class="footer__logo">
          <p class="footer__text"><?php echo date('Y') ;?> - Todos os Direitos Reservados</p>
          <div class="footer__creator">
            <p class="footer__creator-text">Created at:</p>
            <a href="https://jonasborges.dev" class="footer__creator-link" target="_blank">Jonas Borges</a>
          </div>
        </div>
      </div>
    </footer>
